"undefined" == typeof jwplayer && (jwplayer = function (h) {
    ...
    function m(c, a, k, l, b) {
        return function () {
            ...
            if (b) k(c); else {
                try {
                    if (d = c.responseXML) if (f = d.firstChild, d.lastChild && "parsererror" === d.lastChild.nodeName) {
                        l && l("Invalid XML",
                            a, c);
                        return
                    }
                ...
                if (d && f) return k(c);
                (d = e.parseXML(c.responseText)) && d.firstChild ? (c = e.extend_new({}, c, {responseXML: d}), k(c)) : l && l(c.responseText ? "Invalid XML" : a, a, c)
            }
        }
    }

    var j = document, g = window, b = navigator, e = h.utils = {};
    e.exists = function (c) {
        switch (typeof c) {
            case "string":
                return 0 < c.length;
    ...
    e.getAbsolutePath = function (c, a) {
        ...
        if (e.exists(c)) {
            ...
            var l = a.substring(k.length, a.indexOf("/", k.length + 1)), b;
    ...
    e.translateEventResponse = function (c, a) {
        var k = e.extend_new({}, a);
        if (c == h.events.JWPLAYER_FULLSCREEN && !k.fullscreen) k.fullscreen = "true" === k.message, delete k.message; else if ("object" == typeof k.data) {
            var l = k.data;
            delete k.data;
            k = e.extend_new(k, l)
    ...
    var f = e.pluginPathType = {ABSOLUTE: 0, RELATIVE: 1, CDN: 2};
    ...
    e.ajax = function (c, a, k, l) {
        ...
        if (c && 0 <= c.indexOf("://") && c.split("/")[2] != g.location.href.split("/")[2] && e.exists(g.XDomainRequest)) b = new g.XDomainRequest, b.onload = m(b, c, a, k, l), b.ontimeout = b.onprogress = function () {
        }, b.timeout = 5E3; else if (e.exists(g.XMLHttpRequest)) {
    ...
    e.filterPlaylist = function (a, b, k) {
        var l = [], d, f, g, j;
        for (d = 0; d < a.length; d++) if (f = e.extend_new({}, a[d]), f.sources = e.filterSources(f.sources, !1, k), 0 < f.sources.length) {
            for (g = 0; g < f.sources.length; g++) j = f.sources[g], j.label || (j.label = g.toString());
            l.push(f)
        }
        if (b && 0 === l.length) for (d = 0; d < a.length; d++) if (f = e.extend_new({}, a[d]),
    ...
    e.filterSources = function (a, b, k) {
        ...
        if (a) {
            ...
            for (var f = 0; f < a.length; f++) {
                var g = e.extend_new({}, a[f]), j = g.file, p = g.type;
    ...
    var b = h.utils, e = {}, p, a = {}, f = null, c = {};
    b.cssKeyframes = function (a, b) {
        var c = e.keyframes;
        c || (c = d(), e.keyframes = c);
        var c = c.sheet, f = "@keyframes " + a + " { " + b + " }";
        try {
    ...
    n.block = function (a) {
        null === f && (f = {id: a, styleSheets: {}, elements: []})
    };
    ...
    b.hexToRgba = function (a, b) {
        var c = "rgb", f = [parseInt(a.substr(1, 2), 16), parseInt(a.substr(3, 2), 16), parseInt(a.substr(5, 2), 16)];
    ...
    var d = h.loaderstatus = {NEW: 0, LOADING: 1, ERROR: 2, COMPLETE: 3}, m = document;
    h.scriptloader = function (j) {
        ...
        var e = jwplayer.events, p = h.extend_new(this, new e.eventdispatcher), a = d.NEW;
        this.load = function () {
            if (a == d.NEW) {
    ...
    h.xmlAttribute = function (d, h) {
        for (var j = 0; j < d.attributes.length; j++) if (d.attributes[j].name && d.attributes[j].name.toLowerCase() == h.toLowerCase()) return d.attributes[j].value.toString();
        return ""
    };
    ...
    h.touch = function (j) {
        ...
        function e(a, b) {
            ...
            var d = p.getBoundingClientRect(),
                f = {type: a, target: p, x: f.pageX - window.pageXOffset - d.left, y: f.pageY, deltaX: 0, deltaY: 0};
            a != k.TAP && c && (f.deltaX = f.x - c.x, f.deltaY = f.y - c.y);
            return f
        }

        var p = j, a = !1, f = {}, c = null, n = !1, k = h.touchEvents;
    ...
    var m = {
        ...
        encode: function (d, b) {
            var e, h, a, f, c = [], n = "", k, l, r = m.code;
            l = ("undefined" == typeof b ? 0 : b) ? j.encode(d) : d;
            k = l.length % 3;
            if (0 < k) for (; 3 > k++;) n += "\x3d", l += "\x00";
    ...
    function (h) {
        ...
        h.events.eventdispatcher = function (m, j) {
            ...
            this.removeEventListener = function (e, a) {
                if (b[e]) {
                    try {
                        ...
                        for (var f = 0; f < b[e].length; f++) if (b[e][f].listener.toString() == a.toString()) {
                            b[e].splice(f, 1);
                            break
                        }
                    } catch (c) {
            ...
            this.sendEvent = function (p, a) {
                d.exists(a) || (a = {});
                d.extend_new(a, {id: m, version: h.version, type: p});
                j && d.log(p, a);
                g(b[p], a, p);
                g(e, a, p)
            }
    ...
    var d = jwplayer.utils, m = jwplayer.events;
    ...
    h.plugin = function (j) {
        ...
        var p = d.loaderstatus.NEW, a, f, c, n, k = new m.eventdispatcher;
        d.extend_new(this, k);
        this.load = function () {
            if (p == d.loaderstatus.NEW) if (0 < j.lastIndexOf(".swf")) a = j, p = d.loaderstatus.COMPLETE, k.sendEvent(m.COMPLETE); else if (d.getPluginPathType(j) == d.pluginPathType.CDN) p = d.loaderstatus.COMPLETE, k.sendEvent(m.COMPLETE); else {
    ...
    var d = h.utils, m =
        h.events, j = d.foreach;
    h.plugins.pluginloader = function (g, b) {
        function e() {
            c && l.sendEvent(m.ERROR, {message: n});
        ...
        function p() {
            ...
            if (!f && !c) {
                ...
                d.foreach(k, function (f) {
                    ...
                    var g = b[f];
                    f = g.getJS();
                    var l = g.getTarget(), g = g.getStatus();
                    if (g == d.loaderstatus.LOADING || g == d.loaderstatus.NEW) a++; else if (f && (!l || parseFloat(l) > parseFloat(h.version))) c = !0, n = "Incompatible player version", e()
                });
                0 === a && e()
            }
        }
        ...
        var a = d.loaderstatus.NEW,
            f = !1, c = !1, n, k = b, l = new m.eventdispatcher;
        d.extend_new(this, l);
        this.setupPlugins = function (a, b, c) {
            var f = {length: 0, plugins: {}}, e = 0, l = {}, k = g.getPlugins();
            j(b.plugins, function (g, j) {
                var h = d.getPluginName(g), n = k[h], p = n.getFlashPath(), m = n.getJS(), L = n.getURL();
                p && (f.plugins[p] = d.extend_new({}, j), f.plugins[p].pluginmode = n.getPluginmode(), f.length++);
                try {
    ...
    var d = jwplayer.utils, m = d.xmlAttribute, j = h.localName, g = h.textContent, b = h.numChildren,
        e = h.mediaparser =
            function () {
            };
    e.parseGroup = function (h, a) {
        var f, c, n = [];
        for (c = 0; c < b(h); c++) if (f = h.childNodes[c], "media" == f.prefix && j(f)) switch (j(f).toLowerCase()) {
            case "content":
    ...
    var m = jwplayer.utils, j = h.textContent, g = h.getChildNode,
        b = h.numChildren, e = h.localName;
    h.rssparser = {};
    h.rssparser.parse = function (j) {
        for (var a = [], f = 0; f < b(j); f++) {
            var c = g(j, f);
            if ("channel" == e(c).toLowerCase()) for (var h = 0; h < b(c); h++) {
                var k = g(c, h);
    ...
    h.playlist = function (d) {
        var m = [];
        if ("array" == h.utils.typeOf(d)) for (var j = 0; j < d.length; j++) m.push(new h.playlist.item(d[j])); else m.push(new h.playlist.item(d));
        return m
    }
}(jwplayer), function (h) {
    var d = h.item = function (m) {
        var j = jwplayer.utils,
            g = j.extend_new({}, d.defaults, m), b, e;
    ...
    d.defaults = {
        ...
        mediaid: void 0, title: void 0, sources: [], tracks: []
    }
}(jwplayer.playlist), function (h) {
    var d = jwplayer, m = d.utils, j = d.events, g = d.parsers;
    h.loader = function () {
        function b(b) {
            try {
                ...
                if ("rss" != g.localName(b)) p("Not a valid RSS feed"); else {
                    var e = new h(g.rssparser.parse(b));
                    a.sendEvent(j.JWPLAYER_PLAYLIST_LOADED, {playlist: e})
                }
            } catch (l) {
                p()
            }
        ...
        function p(b) {
            a.sendEvent(j.JWPLAYER_ERROR, {message: b ? b : "Error loading file"})
        }
    ...
    var d = jwplayer.utils, m = {file: void 0, label: void 0, type: void 0, "default": void 0};
    h.source = function (j) {
        var g = d.extend_new({}, m);
    ...
    var d = jwplayer.utils, m = {file: void 0, label: void 0, kind: "captions", "default": !1};
    h.track = function (j) {
        var g = d.extend_new({}, m);
        j || (j = {});
        d.foreach(m, function (b) {
    ...
    var d = h.cast = {}, m = h.utils;
    d.adprovider = function (j, g) {
        function b() {
            c = {message: n, position: 0, duration: -1}
        }
        ...
        var a = new d.provider(j, g), f = m.extend_new(this, a), c, n = "Loading ad", k = 0;
        f.init = function () {
            a.init();
            b()
        };
        ...
        f.updateModel = function (f, e) {
            ...
            h.utils.extend_new(c, f);
            a.updateModel(f, e)
        };
        f.getAdModel = function () {
            var a = m.extend_new({}, c);
    ...
    var j = d.cast, g = d.utils, b = d.events, e = b.state, p = {};
    ...
    j.controller = function (a, f) {
        ...
        function v(a) {
            ...
            a ? y() : (C.sendEvent(b.JWPLAYER_PLAYER_STATE, {oldstate: f.state, newstate: e.BUFFERING}),
                A())
        }
        ...
        function D(c) {
            if ("state" === c.type) {
                if (z && (c.diff.newstate || c.diff.position)) z.destroy(), z = null, f.setVideo(C), f.sendEvent(b.JWPLAYER_CAST_AD_CHANGED, {done: !0});
                C.updateModel(c.diff, c.type);
                c = c.diff;
                void 0 !== c.item && f.item !== c.item && (f.item = c.item, f.sendEvent(b.JWPLAYER_PLAYLIST_ITEM, {index: f.item}))
            } else if ("ad" === c.type) {
        ...
        function H() {
            var a = g.extend_new({}, f.config);
            a.cast = g.extend_new({pageUrl: P}, I);
        ...
        function L(a) {
            var c = K.volume !== a;
            c && (K.volume = a, C.sendEvent(b.JWPLAYER_MEDIA_VOLUME, {volume: a}));
            return c
        }

        function Q(a) {
            var c = K.mute !== a;
            c && (K.mute = a, C.sendEvent(b.JWPLAYER_MEDIA_MUTE, {mute: a}));
            return c
        }
        ...
        var w = null, M = {available: !1, active: !1, deviceName: ""}, K = {volume: null, mute: null},
            P = h.location.href, I, C = null, z = null, N = null;
        c = f.volume;
        n = f.mute;
        var J = null, R = null;
        I = g.extend_new({}, p, f.cast);
        m(I, "loadscreen");
        m(I, "endscreen");
        m(I, "logo");
        if (I.appid && (!h.cast ||
    ...
    window.chrome = d;
    var a = h.cast, f = h.utils, c = h.events, n, k = 0, l = "C7EF2AC5";
    a.loader = f.extend_new({
        initialize: function () {
            null !== a.availability ? a.loader.sendEvent("availability", {availability: a.availability}) : d && d.cast ? m() : n || (n = new f.scriptloader("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"), n.addEventListener(c.ERROR, j), n.addEventListener(c.COMPLETE, m), n.load())
        }
    ...
    var j = h.cast, g = h.utils, b = h.events, e = b.state;
    j.provider = function (h, a) {
        ...
        function c(a) {
            ...
            l.newstate = a;
            n.sendEvent(b.JWPLAYER_PLAYER_STATE, {oldstate: l.oldstate, newstate: l.newstate})
        }

        var n = g.extend_new(this, new b.eventdispatcher("cast.provider")), k = -1,
            l = {newstate: e.IDLE, oldstate: e.IDLE, buffer: 0, position: 0, duration: -1, audioMode: !1};
        n.isCaster = !0;
        n.init = function () {
        };
        n.destroy = function () {
        ...
        n.updateModel = function (a, c) {
            ...
            if ("ad" !== c) {
                ...
                void 0 !== a.buffer && (l.buffer = a.buffer, n.sendEvent(b.JWPLAYER_MEDIA_BUFFER, {bufferPercent: l.buffer}))
            }
        };
        ...
        n.seek = function (a) {
            c(e.BUFFERING);
            n.sendEvent(b.JWPLAYER_MEDIA_SEEK, {position: l.position, offset: a});
            f("seek", a)
        };
    ...
    var j = h.utils, g = h.events, b = !0, e = !1, p = document, a = h.embed = function (f) {
        function c() {
            if (!B) if ("array" === j.typeOf(u.playlist) && 2 > u.playlist.length && (0 === u.playlist.length || !u.playlist[0].sources || 0 === u.playlist[0].sources.length)) l(); else if (!G) if ("string" === j.typeOf(u.playlist)) A = new h.playlist.loader, A.addEventListener(g.JWPLAYER_PLAYLIST_LOADED,
                function (a) {
                ...
                G = e;
                l(a)
            }), G = b, A.load(u.playlist); else if (v.getStatus() == j.loaderstatus.COMPLETE) {
                for (var k = 0; k < u.modes.length; k++) if (u.modes[k].type && a[u.modes[k].type]) {
                    var p = j.extend_new({}, u), m = new a[u.modes[k].type](y, u.modes[k], p, v, f);
                    if (m.supportsConfig()) return m.addEventListener(g.ERROR, n), m.embed(), j.css("object.jwswf, .jwplayer:focus", {outline: "none"}), j.css(".jw-tab-focus:focus", {outline: "solid 2px #0B7EF4"}), d(f,
                        p.events), f
                }
                var q;
        ...
        function k(a) {
            f.dispatchEvent(g.JWPLAYER_ERROR, {message: "Could not load plugin: " + a.message})
        }

        function l(a) {
            a && a.message ? x("Error loading playlist: " + a.message) : x(E + "<a style='color:#ffffff' target='_blank' href='http://get.adobe.com/cn/flashplayer/'>点击这里安装</a>")
        }
        ...
        function r(a, b) {
            ...
            D = setTimeout(function () {
                D = null;
                f.dispatchEvent(g.JWPLAYER_SETUP_ERROR, {message: a, fallback: b})
            }, 0)
        }
        ...
        var u = new a.config(f.config), t = u.width, q = u.height, E = "您必须安装Flash Player才能观看视频: ",
            F = p.getElementById(f.id), v = h.plugins.loadPlugins(f.id, u.plugins), A, G = e, B = e, D = null, H = null;
    ...
    function d(b) {
        if (b.playlist) for (var d = 0; d < b.playlist.length; d++) b.playlist[d] = new g(b.playlist[d]);
        else {
            var h = {};
    ...
    var j = h.utils, g = h.playlist.item;
    (h.embed.config = function (b) {
        ...
        d(b);
        g = b.aspectratio;
        if ("string" != typeof g || !j.exists(g)) e = 0; else {
            var a = g.indexOf(":");
            -1 == a ? e = 0 : (e = parseFloat(g.substr(0, a)), g = parseFloat(g.substr(a + 1)), e = 0 >= e || 0 >= g ? 0 : 100 * (g / e) + "%")
        }
        ...
        d(e);
        return j.extend_new(b, e)
    }
}(jwplayer), function (h) {
    var d = h.utils, m = document;
    h.embed.download = function (j, g, b) {
        ...
        var a = d.extend_new({}, g), f = a.width ? a.width : 480, c = a.height ? a.height : 320, n;
        g = g.logo ? g.logo : {
            prefix: d.repo(), file: "logo.png",
            margin: 10
        };
        var k, l, r, a = a.playlist, x, u = ["mp4", "aac", "mp3"];
        if (a && a.length) {
            x = a[0];
            n = x.sources;
            for (a = 0; a < n.length; a++) {
                var t = n[a], q = t.type ? t.type : d.extensionmap.extType(d.extension(t.file));
    ...
    (h.embed.flash = function (b, e, p, a, f) {
        ...
        var l = new h.events.eventdispatcher, r = d.flashVersion();
        d.extend_new(this, l);
        this.embed = function () {
            p.id = f.id;
            if (10 > r) return l.sendEvent(m.ERROR, {message: "Flash version must be 10.0 or greater"}), !1;
            var g, h, t = f.config.listbar, q = d.extend_new({},
                p);
            if (b.id + "_wrapper" == b.parentNode.id) g = document.getElementById(b.id + "_wrapper"); else {
            ...
            0 < g.length ? d.extend_new(q, k(g.plugins)) : delete q.plugins;
        ...
        this.supportsConfig = function () {
            if (r) if (p) {
                ...
                try {
                    ...
                    for (var b = 0; b < a.length; b++) if (a[b].file && g(a[b].file, a[b].type)) return !0
                } catch (c) {
                }
            } else return !0;
            return !1
    ...
    var m = h.utils, j = m.extensionmap, g = h.events;
    h.embed.html5 = function (b, e, j, a, f) {
        ...
        var k = this, l = new g.eventdispatcher;
        m.extend_new(k, l);
        k.embed = function () {
            if (h.html5) {
                a.setupPlugins(f, j, c);
                b.innerHTML = "";
                var d = h.utils.extend_new({}, j);
                delete d.volume;
        ...
        k.supportsConfig = function () {
            if (h.vid.canPlayType) try {
                ...
                for (var a = j.playlist[0].sources, b = 0; b < a.length; b++) if (d(a[b].file, a[b].type, j.androidhls)) return !0
            } catch (c) {
            }
            return !1
        }
    ...
    var d = h.embed, m = h.utils, j = /\.(js|swf)$/;
    h.embed = m.extend_new(function (g) {
        function b() {
            t = "Adobe SiteCatalyst Error: Could not find Media Module"
        }

        var e = m.repo(), p = m.extend_new({}, h.defaults), a = m.extend_new({}, p, g.config), f = g.config,
            c = a.plugins, n = a.analytics, k = e + "jwpsrv.js", l = e + "sharing.js", r = e + "related.js",
            x = e + "gapro.js",
            p = h.key ? h.key : p.key, u = (new h.utils.key(p)).edition(), t, c = c ? c : {};
    ...
    function (h) {
        ...
        h.sitecatalyst = function (h) {
            ...
            var p = h, a = d.extend_new({}, p.config.sitecatalyst), f = {
                onPlay: function () {
                    if (!x) {
                        var a = p.getPosition();
                        l = !1;
                ...
                }, onPause: b, onBuffer: b, onIdle: e, onPlaylistItem: function (b) {
                    try {
                        x =
                            !0;
                        e();
                        k = 0;
                        var f;
                        if (a.mediaName) f = a.mediaName; else {
    ...
    var m = [], j = h.utils, g = h.events, b = g.state, e = document,
        ...
        }, c = {onBuffer: b.BUFFERING, onPause: b.PAUSED, onPlay: b.PLAYING, onIdle: b.IDLE};
    h.api = function (m) {
        function k(a, b) {
        ...
        var q = this, E = {}, F = {}, v, A = !1, G = [], B, D, H = {}, y = {};
        q.container = m;
        q.id = m.id;
        q.setup = function (a) {
            if (h.embed) {
        ...
        q.resize = function (a, b) {
            if ("flash" !== q.renderingMode) t("jwResize", a, b); else {
                var c = e.getElementById(q.id + "_wrapper"), d = e.getElementById(q.id + "_aspect");
        ...
        q.dispatchEvent = function (a, b) {
            var c = E[a];
            if (c) for (var c = c.slice(0), d = j.translateEventResponse(a, b), e = 0; e < c.length; e++) {
                var f =
                    c[e];
    ...
    h.api.addPlayer = function (a) {
        for (var b = 0; b < m.length; b++) if (m[b] == a) return a;
        m.push(a);
        return a
    };
    ...
    var d = h.events, m = h.utils, j = d.state;
    h.api.instream = function (g, b) {
        ...
        k.removeEventListener =
            function (a, b) {
                var d = c[a];
                if (d) for (var e = d.length; e--;) d[e] === b && d.splice(e, 1)
            };
        k.dispatchEvent = function (a, b) {
            var d = c[a];
            if (d) for (var d = d.slice(0), e = m.translateEventResponse(a, b[1]), f = 0; f < d.length; f++) {
                var g = d[f];
