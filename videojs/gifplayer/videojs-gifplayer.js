...
// http://stackoverflow.com/a/7557433/2066736
                ...
                function inScroll(el) {
                    ...
                    var scrollEl = getScrollElement(el);

                    if (scrollEl) {
                        var scrollRect = scrollEl.getBoundingClientRect();

                        return scrollRect.top <= elRect.top && scrollRect.left <= elRect.left && scrollRect.bottom >= elRect.bottom && scrollRect.right >= elRect.right;
                    }
...
// pause every gif that is out of viewport
                var autoPlayGifs = (0, _lodash2.default)(function () {
                    var gifPlayers = document.querySelectorAll('.vjs-gifplayer');

                    for (var _iterator = gifPlayers, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator](); ;) {
                        var _ref;
...
// if the page is shown, play the video
                function handleVisibilityChange() {
                    if (document[hidden]) {
                        ...
                        for (var _iterator2 = gifPlayers, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator](); ;) {
                            var _ref2;
                 ...
                 */
                var gifplayer = function gifplayer(options) {
                    var _this = this;
