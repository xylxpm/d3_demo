...
// Tech that can be registered as a Component.
    ...
    var LoopToggle = function (_Button) {
        inherits(LoopToggle, _Button);

        function LoopToggle(player, options) {
            classCallCheck(this, LoopToggle);
            var _this = possibleConstructorReturn(this, _Button.call(this, player, options));
            return _this;
        }

        LoopToggle.prototype.buildCSSClass = function buildCSSClass() {
            return 'vjs-noloop-control ' + _Button.prototype.buildCSSClass.call(this);
        };

        LoopToggle.prototype.handleClick = function handleClick(event) {
            this.player_.options_.loop = !this.player_.options_.loop;
            if(this.player_.options_.loop){
                this.addClass('vjs-loop-control');
            }else{
                this.removeClass('vjs-loop-control');
            }
        };

        return LoopToggle;
    }(Button);
    LoopToggle.prototype.controlText_ = 'loop';
...
// Required children
    ...
    ControlBar.prototype.options_ = {
        children: ['playToggle', 'volumePanel', 'loopToggle', 'currentTimeDisplay', 'timeDivider', 'durationDisplay', 'progressControl', 'liveDisplay', 'remainingTimeDisplay', 'customControlSpacer', 'playbackRateMenuButton', 'chaptersButton', 'descriptionsButton', 'subsCapsButton', 'audioTrackButton', 'fullscreenToggle']
    };
